...
Put installable source under the single `base` registry folder.
...
```tsx
import { MyComponent } from "@/registry/base/my-component";
...
Put block source under a named folder in the `base` registry:

```txt
src/registry/base/my-block/page.tsx
src/registry/base/my-block/components/my-block-sidebar.tsx
```
...
```json
{
  ...
  "files": [
    {
      "path": "src/registry/base/my-block/page.tsx",
      "type": "registry:page",
      "target": "app/dashboard/page.tsx"
    },
    {
      "path": "src/registry/base/my-block/components/my-block-sidebar.tsx",
...
```tsx
import MyBlockPage from "@/registry/base/my-block/page";
...
Most new blocks only require three edits: add files under `src/registry/base`, add the block item to `registry.json`, and register the preview in `src/shared/lib/registry.ts`. Add category titles or category art only when the defaults are not enough.
